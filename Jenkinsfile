pipeline {
    ...
    stages{
        ...
        stage("Docker Build") {
            steps {
                script{
                    sh "aws ecr get-login-password --region us-east-1 --profile sunny.thackar@unyscape.com | docker login --username AWS --password-stdin 738448646260.dkr.ecr.us-east-1.amazonaws.com"
